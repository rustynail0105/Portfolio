        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/rustynail102"}
            />
            {/* Linkedin icon */}
            ...
            <IconClickableWithAnimation
              Icon={DiscordIcon}
              href={"https://discord.com/users/1126623218980106433"}
            />
            <IconClickableWithAnimation Icon={TelegramIcon} href={"https://t.me/rustynail102"} />
          </div>
