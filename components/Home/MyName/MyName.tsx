    ...
    >
      ...
      >
        <span className="text-gray-400  tracking-wide">
          In-depth knowledge of software development lifecycle and specialized
          in smart contract architecture. Well-versed in addressing real user
          problems and leveraging Web3, AI, and ZKP technologies to enhance
          trust, data management, and privacy.
        </span>
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
