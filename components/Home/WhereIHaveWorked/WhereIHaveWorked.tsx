...
import Alcacor from "./Descriptions/Alcacor";
import UseTech from "./Descriptions/UseTech";
import BairesDev from "./Descriptions/BairesDev";
import SoftwareMind from "./Descriptions/SoftwareMind";
import Groupon from "./Descriptions/Groupon";
import Nguyen from "./Descriptions/Nguyen";
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          ...
          <CompanyButton
            ...
            CompanyName="Nguyen Technical Services"
            BarPosition={210}
            BarAvobePosition={385}
            DescriptionJob="Nguyen"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              false,
